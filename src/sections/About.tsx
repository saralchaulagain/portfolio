...
const About = () => {
  return (
    <Box className="about h-screen w-full flex justify-center items-center gap-3 pt-2 bg-about my-0 max-md:px-4">
      <Box className=" max-md:w-full">
        ...
        <Box className="grid grid-cols-3 mt-6 gap-2 card-text max-md:grid-cols-2  ">
          ...
          <Box className="border bg-[#ffffff] py-1 px-2  flex flex-col justify-center gap-4 rounded-2xl card-hover max-md:col-span-2">
            <Typography variant="subtitle1" className=" text-center ">
